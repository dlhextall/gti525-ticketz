...
public class ShowBank {
	...
	protected ShowBank() {
		...
		shows.add(new Show(0, "Black Keys Tour", "The Black Keys est un groupe de blues rock américain originaire d'Akron dans l'État de l'Ohio1,2. Le groupe est composé du chanteur et guitariste Dan Auerbach et du batteur Patrick Carney.", "Centre Bell", "resources/images/carousel/img1.jpg", representations, null, DateTime.now().minusDays(2), DateTime.now()));
