...
public class ShowBank {
	...
	protected ShowBank() {
		...
		shows.add(new Show(0, "Black Keys Tour", "Tickets On Sale Now!", "Centre Bell", "/resources/images/carousel/img1.jpg", representations, null, DateTime.now().minusDays(2), DateTime.now(), true));
